...
('d2000053-0000-0000-0000-000000000053'::uuid, 'content', 2, 'Classification and Anatomy', 'ANATOMICAL CLASSIFICATION:
...
('d2000053-0000-0000-0000-000000000053'::uuid, 'content', 3, 'Common Conditions', 'HYDROCELE:
...
('d2000053-0000-0000-0000-000000000053'::uuid, 'content', 4, 'Emergencies and Testicular Tumors', 'TESTICULAR TORSION:
...
('d2000053-0000-0000-0000-000000000053'::uuid, 2, 'Transillumination is positive in:', 'Testicular tumor', 'Hydrocele', 'Varicocele', 'Hematocele', 'Hernia', 'B', 'Hydrocele (fluid collection) transilluminates. Hematocele (blood) and solid masses do not.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 3, 'Primary vaginal hydrocele is most common in:', 'Newborns', 'Children', 'Young adults', 'Elderly men', 'Adolescents', 'D', 'Primary (idiopathic) vaginal hydrocele is most common in elderly men. Secondary hydrocele occurs at any age.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 4, 'In hydrocele, the testis is:', 'Easily palpable', 'Usually not palpable', 'Hard', 'Tender', 'Absent', 'B', 'In hydrocele, the testis is usually not palpable separately as it is surrounded by fluid.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 5, 'What must be excluded in every case of hydrocele?', 'Hernia', 'Underlying testicular tumor', 'Varicocele', 'Epididymitis', 'Torsion', 'B', 'Underlying testicular tumor must be excluded in every hydrocele case using ultrasound examination.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 6, 'Surgical treatment of hydrocele involves:', 'Radical orchiectomy', 'Jaboulay procedure or Lords plication', 'Herniorrhaphy', 'Varicocelectomy', 'Epididymectomy', 'B', 'Hydrocele repair involves Jaboulay procedure (eversion) or Lords plication of the tunica vaginalis.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 7, 'Epididymal cyst is located:', 'In front of testis', 'Behind and above testis', 'Within the testis', 'In inguinal canal', 'Attached to cord', 'B', 'Epididymal cyst/spermatocele is located behind and above the testis, separate from the testis.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 8, 'Prehn sign positive (pain relief with testicular elevation) suggests:', 'Testicular torsion', 'Epididymitis', 'Testicular tumor', 'Hernia', 'Hydrocele', 'B', 'Positive Prehn sign (pain relief on elevation) suggests epididymitis. Torsion pain is not relieved.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 9, 'Testicular torsion must be surgically corrected within:', '1 hour', '6 hours', '24 hours', '48 hours', '72 hours', 'B', 'Testicular torsion requires correction within 6 hours for optimal salvage. Salvage rate drops significantly after this.'),
...
('d2000053-0000-0000-0000-000000000053'::uuid, 11, 'Absent cremasteric reflex is suggestive of:', 'Epididymitis', 'Testicular torsion', 'Hydrocele', 'Varicocele', 'Hernia', 'B', 'Absent cremasteric reflex is a key sign of testicular torsion.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 12, 'Fournier gangrene is:', 'Testicular tumor', 'Necrotizing fasciitis of perineum', 'Epididymal abscess', 'Chronic orchitis', 'Hydrocele with infection', 'B', 'Fournier gangrene is necrotizing fasciitis of the perineum and scrotum requiring emergency debridement.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 13, 'Most important risk factor for Fournier gangrene is:', 'Smoking', 'Diabetes mellitus', 'Hypertension', 'Age', 'Obesity', 'B', 'Diabetes mellitus is the most significant risk factor for Fournier gangrene.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 14, 'Solid testicular mass in a young male should be considered as:', 'Benign until proven otherwise', 'Cancer until proven otherwise', 'Infection', 'Torsion', 'Trauma', 'B', 'Any solid testicular mass should be considered malignant until proven otherwise.'),
...
('d2000053-0000-0000-0000-000000000053'::uuid, 16, 'Varicocele feels like:', 'Solid mass', 'Cystic swelling', 'Bag of worms', 'Tender nodule', 'Fluctuant mass', 'C', 'Varicocele classically feels like a bag of worms due to dilated pampiniform plexus veins.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 17, 'Blue dot sign on scrotal examination indicates:', 'Testicular tumor', 'Torsion of appendix testis', 'Epididymitis', 'Fournier gangrene', 'Varicocele', 'B', 'Blue dot sign (visible blue discoloration near upper pole) indicates torsion of appendix testis.'),
('d2000053-0000-0000-0000-000000000053'::uuid, 18, 'Communicating hydrocele in infants is due to:', 'Tumor', 'Patent processus vaginalis', 'Trauma', 'Infection', 'Torsion', 'B', 'Communicating hydrocele results from patent processus vaginalis allowing peritoneal fluid to enter tunica vaginalis.'),
