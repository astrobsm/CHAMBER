...
('d2000051-0000-0000-0000-000000000051'::uuid, 'content', 3, 'Evaluation', 'HISTORY:
...
('d2000051-0000-0000-0000-000000000051'::uuid, 'content', 4, 'Management', 'LIFESTYLE MODIFICATIONS:
...
('d2000051-0000-0000-0000-000000000051'::uuid, 'clinical_pearls', 5, 'Clinical Pearls', 'Always evaluate the male partner in infertile couple. Varicocele is most common correctable cause. Left-sided varicocele: left testicular vein drains into renal vein at 90 degrees. CBAVD associated with CFTR mutations (CF carrier). Testosterone therapy suppresses spermatogenesis - use hCG/FSH for hypogonadotropic hypogonadism. Two semen analyses required.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 'key_points', 6, 'Key Points Summary', 'Male factors in 50% of infertility. Causes: pretesticular, testicular, post-testicular. Varicocele: most common correctable cause, left-sided, bag of worms. Semen analysis: WHO criteria, two samples. Azoospermia: obstructive (normal FSH) vs non-obstructive (high FSH). Treatment: lifestyle, medical (hCG/FSH), surgical, ART (IUI, IVF, ICSI).');

-- Insert MCQs
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation) VALUES
('d2000051-0000-0000-0000-000000000051'::uuid, 1, 'Most common correctable cause of male infertility is:', 'Cryptorchidism', 'Varicocele', 'Hypogonadism', 'Ejaculatory duct obstruction', 'Antisperm antibodies', 'B', 'Varicocele is the most common correctable cause of male infertility, present in 40% of infertile men.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 2, 'Varicocele is more common on the left side because:', 'Left testis is larger', 'Left testicular vein drains into left renal vein at 90 degrees', 'Left testis is lower', 'Anatomical variation', 'Unknown reason', 'B', 'Left testicular vein drains into the left renal vein at 90 degrees, creating higher pressure than right side (drains into IVC directly).'),
('d2000051-0000-0000-0000-000000000051'::uuid, 3, 'CBAVD (congenital bilateral absence of vas deferens) is associated with:', 'Klinefelter syndrome', 'CFTR gene mutations (cystic fibrosis)', 'Y chromosome microdeletion', 'Turner syndrome', 'Kallmann syndrome', 'B', 'CBAVD is associated with CFTR mutations. Patients and partners should be tested for CF carrier status.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 4, 'Kallmann syndrome is characterized by:', 'Primary testicular failure', 'Hypogonadotropic hypogonadism with anosmia', 'Karyotype 47,XXY', 'Obstructive azoospermia', 'Retrograde ejaculation', 'B', 'Kallmann syndrome is hypogonadotropic hypogonadism (low LH/FSH) with anosmia due to failed GnRH neuron migration.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 5, 'Klinefelter syndrome karyotype is:', '45,XO', '47,XXY', '47,XYY', '46,XX male', '46,XY', 'B', 'Klinefelter syndrome has 47,XXY karyotype with small firm testes, gynecomastia, and azoospermia.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 6, 'Azoospermia is defined as:', 'Low sperm count', 'Absence of sperm in ejaculate', 'Poor motility', 'Abnormal morphology', 'Low volume', 'B', 'Azoospermia is the complete absence of sperm in the ejaculate after centrifugation.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 7, 'In obstructive azoospermia, FSH level is:', 'Elevated', 'Normal', 'Low', 'Variable', 'Unmeasurable', 'B', 'In obstructive azoospermia, FSH is normal because testicular function is preserved. Elevated FSH suggests testicular failure.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 8, 'Treatment for hypogonadotropic hypogonadism to restore fertility is:', 'Testosterone injections', 'hCG and FSH injections', 'Clomiphene alone', 'Estrogen therapy', 'Varicocele repair', 'B', 'hCG (mimics LH) and FSH injections stimulate spermatogenesis. Testosterone suppresses gonadotropins and spermatogenesis.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 9, 'Why should testosterone NOT be used for male infertility?', 'It is expensive', 'It suppresses spermatogenesis', 'It causes liver damage', 'It reduces libido', 'It causes gynecomastia only', 'B', 'Exogenous testosterone suppresses pituitary gonadotropins (LH, FSH) leading to reduced spermatogenesis.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 10, 'WHO 2021 normal sperm concentration is greater than:', '5 million/mL', '10 million/mL', '16 million/mL', '20 million/mL', '40 million/mL', 'C', 'WHO 2021 lower reference limit for sperm concentration is greater than 16 million/mL.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 11, 'How many semen analyses are recommended for diagnosis?', 'One sample', 'Two samples 2-4 weeks apart', 'Three samples', 'Weekly samples for a month', 'One sample is sufficient', 'B', 'Two semen samples at least 2-4 weeks apart are recommended due to natural variability.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 12, 'ICSI is used for:', 'Female factor infertility only', 'Severe male factor infertility', 'Unexplained infertility only', 'Tubal disease', 'Endometriosis only', 'B', 'ICSI (Intracytoplasmic Sperm Injection) is used for severe oligospermia, surgically retrieved sperm, and failed IVF.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 13, 'Varicocele on examination feels like:', 'Solid mass', 'Bag of worms that increases with Valsalva', 'Cystic swelling', 'Tender nodule', 'Normal finding', 'B', 'Varicocele classically feels like a bag of worms (dilated pampiniform plexus) that increases with Valsalva.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 14, 'Micro-TESE is used for:', 'Obstructive azoospermia only', 'Non-obstructive azoospermia', 'Varicocele repair', 'Vasectomy reversal', 'Ejaculatory duct obstruction', 'B', 'Micro-TESE (microsurgical testicular sperm extraction) is used for non-obstructive azoospermia to find focal areas of spermatogenesis.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 15, 'Y chromosome microdeletion testing is indicated for:', 'All infertile men', 'Severe oligospermia or azoospermia', 'Varicocele only', 'Premature ejaculation', 'Erectile dysfunction', 'B', 'Y chromosome microdeletion testing is indicated for men with severe oligospermia (less than 5 million/mL) or non-obstructive azoospermia.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 16, 'Retrograde ejaculation is diagnosed by:', 'Semen analysis', 'Post-ejaculatory urine showing sperm', 'Ultrasound', 'Blood tests', 'Physical examination', 'B', 'Retrograde ejaculation is diagnosed by finding sperm in post-ejaculatory urine sample.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 17, 'Abstinence period before semen analysis should be:', 'Less than 24 hours', '2-7 days', '2 weeks', '1 month', 'No abstinence needed', 'B', 'Recommended abstinence period is 2-7 days for optimal semen analysis results.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 18, 'Elevated FSH with small testes suggests:', 'Obstructive azoospermia', 'Primary testicular failure', 'Hypogonadotropic hypogonadism', 'Ejaculatory duct obstruction', 'Varicocele', 'B', 'Elevated FSH with small testes indicates primary testicular failure (non-obstructive cause).'),
('d2000051-0000-0000-0000-000000000051'::uuid, 19, 'Varicocele repair improves semen parameters in approximately:', '20-30%', '40-50%', '60-70%', '90-100%', '10%', 'C', 'Varicocele repair (microsurgical ligation) improves semen parameters in 60-70% of men.'),
('d2000051-0000-0000-0000-000000000051'::uuid, 20, 'Hyperprolactinemia causing infertility is treated with:', 'Testosterone', 'Dopamine agonists (cabergoline)', 'GnRH agonists', 'Clomiphene', 'Surgery only', 'B', 'Dopamine agonists (cabergoline, bromocriptine) lower prolactin and restore gonadotropin secretion.');
