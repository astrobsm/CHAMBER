...
('d0000046-0000-0000-0000-000000000046'::uuid, 'content', 3, 'Medical Management', 'WATCHFUL WAITING: For mild symptoms (IPSS less than 8) with minimal bother. Lifestyle modifications: reduce caffeine/alcohol, bladder training, timed voiding.
...
('d0000046-0000-0000-0000-000000000046'::uuid, 'content', 4, 'Surgical Management', 'INDICATIONS: Refractory to medical therapy, recurrent urinary retention, recurrent UTI, bladder stones, renal impairment, patient preference.
...
('d0000046-0000-0000-0000-000000000046'::uuid, 'clinical_pearls', 5, 'Clinical Pearls', 'BPH affects transition zone; cancer affects peripheral zone. Alpha-blockers work quickly; 5ARIs take months. Tamsulosin can cause IFIS during cataract surgery. Always double PSA value if patient on 5ARI. TURP is gold standard but causes retrograde ejaculation. UroLift and Rezum preserve ejaculatory function.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 'key_points', 6, 'Key Points Summary', 'BPH arises in transition zone, present in 50% by age 50. LUTS: storage and voiding symptoms. Alpha-blockers first-line, rapid onset. 5ARIs reduce size but take months, reduce PSA by 50%. TURP is gold standard surgery. Complications: TUR syndrome (rare with bipolar), retrograde ejaculation. Newer techniques (UroLift, Rezum) preserve ejaculation.');

-- Insert MCQs
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation) VALUES
('d0000046-0000-0000-0000-000000000046'::uuid, 1, 'BPH arises from which zone of the prostate?', 'Peripheral zone', 'Transition zone', 'Central zone', 'Anterior fibromuscular zone', 'All zones equally', 'B', 'BPH arises from the transition zone surrounding the urethra, unlike prostate cancer which mainly affects the peripheral zone.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 2, 'First-line medical therapy for BPH is:', '5-alpha reductase inhibitors', 'Alpha-blockers', 'Antimuscarinics', 'Antibiotics', 'Phosphodiesterase inhibitors', 'B', 'Alpha-blockers (tamsulosin, alfuzosin) are first-line therapy with rapid onset of action.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 3, 'Alpha-blockers work by:', 'Reducing prostate size', 'Relaxing prostatic smooth muscle', 'Blocking androgens', 'Increasing bladder contractility', 'Reducing urine production', 'B', 'Alpha-blockers relax smooth muscle in the prostate and bladder neck by blocking alpha-1 adrenergic receptors.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 4, '5-alpha reductase inhibitors take how long to show effect?', 'Days', 'Weeks', '3-6 months', '1 year', 'Immediate', 'C', '5ARIs (finasteride, dutasteride) take 3-6 months to show maximal effect as they reduce prostate size.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 5, 'Effect of 5-alpha reductase inhibitors on PSA is:', 'No change', 'Increase by 50%', 'Decrease by approximately 50%', 'Variable', 'Complete suppression', 'C', '5ARIs reduce PSA by approximately 50%. The PSA value must be doubled for cancer screening purposes.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 6, 'TURP syndrome is caused by:', 'Infection', 'Bleeding', 'Absorption of hypotonic irrigation fluid causing hyponatremia', 'Urethral stricture', 'Retrograde ejaculation', 'C', 'TUR syndrome results from absorption of hypotonic glycine irrigation causing dilutional hyponatremia. Rare with bipolar TURP (saline irrigation).'),
('d0000046-0000-0000-0000-000000000046'::uuid, 7, 'Most common complication after TURP is:', 'Erectile dysfunction', 'Retrograde ejaculation', 'Urethral stricture', 'TUR syndrome', 'Incontinence', 'B', 'Retrograde ejaculation occurs in 70-90% of patients after TURP due to damage to the bladder neck.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 8, 'IPSS is used to assess:', 'Prostate size', 'Severity of lower urinary tract symptoms', 'Cancer risk', 'PSA level', 'Bladder function', 'B', 'IPSS (International Prostate Symptom Score) is a 7-question validated tool to assess LUTS severity.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 9, 'Intraoperative Floppy Iris Syndrome (IFIS) is associated with:', 'Finasteride', 'Tamsulosin', 'Terazosin', 'Dutasteride', 'Tadalafil', 'B', 'IFIS during cataract surgery is associated with tamsulosin (and other alpha-blockers, especially alpha-1A selective).'),
('d0000046-0000-0000-0000-000000000046'::uuid, 10, 'Voiding (obstructive) symptoms include all EXCEPT:', 'Hesitancy', 'Weak stream', 'Urgency', 'Straining', 'Intermittency', 'C', 'Urgency is a storage (irritative) symptom. Voiding symptoms include hesitancy, weak stream, straining, intermittency.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 11, 'Storage symptoms include all EXCEPT:', 'Frequency', 'Nocturia', 'Urgency', 'Poor stream', 'Urge incontinence', 'D', 'Poor stream is a voiding (obstructive) symptom. Storage symptoms include frequency, urgency, nocturia.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 12, 'On uroflowmetry, Qmax suggesting obstruction is:', 'Greater than 25 ml/s', 'Greater than 20 ml/s', 'Less than 15 ml/s', 'Less than 25 ml/s', 'Any value', 'C', 'Qmax (maximum flow rate) less than 15 ml/s suggests bladder outlet obstruction.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 13, 'Indications for BPH surgery include all EXCEPT:', 'Mild symptoms well controlled on medication', 'Recurrent urinary retention', 'Bladder stones', 'Recurrent UTI', 'Renal impairment due to obstruction', 'A', 'Surgery is indicated for refractory symptoms, retention, stones, recurrent UTI, renal impairment. Well-controlled symptoms do not require surgery.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 14, 'HoLEP stands for:', 'High-output laser endoscopic prostatectomy', 'Holmium laser enucleation of prostate', 'Hot laser excision of prostate', 'Harmonic laser evacuation procedure', 'None of the above', 'B', 'HoLEP - Holmium Laser Enucleation of Prostate - excellent for large prostates with durable results.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 15, 'Simple prostatectomy differs from radical prostatectomy in that:', 'It removes the capsule', 'It removes only the adenoma, preserving the capsule', 'It is done for cancer', 'It includes lymph node dissection', 'It removes seminal vesicles', 'B', 'Simple prostatectomy for BPH removes the adenoma but preserves the prostatic capsule, unlike radical prostatectomy for cancer.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 16, 'Procedure that preserves ejaculatory function is:', 'TURP', 'HoLEP', 'UroLift', 'Simple prostatectomy', 'TUMT', 'C', 'UroLift (prostatic urethral lift) preserves ejaculatory function as it does not remove or ablate tissue.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 17, 'Rezum treatment uses:', 'Laser energy', 'Radiofrequency', 'Water vapor thermal therapy', 'Cryotherapy', 'Microwave', 'C', 'Rezum uses convective water vapor (steam) to ablate prostatic tissue.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 18, 'Which medication is suitable for BPH with concurrent erectile dysfunction?', 'Tamsulosin', 'Finasteride', 'Tadalafil', 'Oxybutynin', 'Doxazosin', 'C', 'Tadalafil (PDE5 inhibitor) is approved for BPH/LUTS and is especially useful when ED is also present.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 19, 'Complication of untreated severe BPH includes:', 'Prostate cancer', 'Hydronephrosis and renal impairment', 'Testicular atrophy', 'Penile shortening', 'Gynecomastia', 'B', 'Untreated BOO from BPH can cause bladder dysfunction, hydronephrosis, and obstructive uropathy with renal impairment.'),
('d0000046-0000-0000-0000-000000000046'::uuid, 20, 'Bipolar TURP advantage over monopolar is:', 'Faster procedure', 'Reduced TUR syndrome risk', 'Better hemostasis', 'Smaller prostate treatment', 'Cheaper equipment', 'B', 'Bipolar TURP uses saline irrigation instead of glycine, virtually eliminating TUR syndrome risk.');
