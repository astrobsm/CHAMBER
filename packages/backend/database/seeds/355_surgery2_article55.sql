...
('d0000055-0000-0000-0000-000000000055'::uuid, 'content', 3, 'Common Conditions in Detail', 'THYROGLOSSAL DUCT CYST:
...
('d0000055-0000-0000-0000-000000000055'::uuid, 'content', 4, 'Evaluation and Management', 'HISTORY:
...
Rhabdomyosarcoma'),
('d0000055-0000-0000-0000-000000000055'::uuid, 'clinical_pearls', 5, 'Clinical Pearls', 'Most pediatric neck masses are benign (90%). Most common overall: reactive lymphadenopathy. Most common congenital midline: thyroglossal duct cyst - moves with tongue protrusion. Most common branchial: second cleft. Sistrunk procedure: cyst + central hyoid + tract to foramen cecum. Cystic hygroma: posterior triangle, transilluminates. Red flags: supraclavicular, fixed, greater than 3cm, B symptoms.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 'key_points', 6, 'Key Points Summary', 'Pediatric neck masses usually benign. Location guides diagnosis: midline (thyroglossal, dermoid) vs lateral (branchial, lymph nodes, cystic hygroma). Thyroglossal cyst: moves with tongue protrusion, Sistrunk procedure. Branchial cleft: second most common, anterior to SCM. Cystic hygroma: posterior triangle, transilluminates. Malignancy: lymphoma, thyroid cancer - look for red flags.');

-- Insert MCQs
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation) VALUES
('d0000055-0000-0000-0000-000000000055'::uuid, 1, 'Most common cause of neck mass in children is:', 'Thyroglossal duct cyst', 'Branchial cleft cyst', 'Reactive lymphadenopathy', 'Cystic hygroma', 'Lymphoma', 'C', 'Reactive lymphadenopathy (usually viral or bacterial) is the most common cause of neck mass in children.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 2, 'Most common congenital midline neck mass is:', 'Dermoid cyst', 'Thyroglossal duct cyst', 'Thyroid goiter', 'Teratoma', 'Branchial cyst', 'B', 'Thyroglossal duct cyst is the most common congenital midline neck mass in children.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 3, 'Thyroglossal duct cyst characteristically:', 'Moves with swallowing only', 'Moves with tongue protrusion', 'Does not move', 'Is located laterally', 'Transilluminates', 'B', 'Thyroglossal duct cyst moves upward with tongue protrusion (and swallowing). This is unique to thyroglossal duct cyst.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 4, 'The Sistrunk procedure includes removal of:', 'Cyst only', 'Cyst and thyroid gland', 'Cyst, central hyoid body, and tract to foramen cecum', 'Cyst and entire hyoid bone', 'Cyst and surrounding lymph nodes', 'C', 'Sistrunk procedure removes the cyst, the central portion of hyoid bone, and the tract up to the foramen cecum to prevent recurrence.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 5, 'Recurrence rate after simple excision of thyroglossal cyst vs Sistrunk procedure is:', 'Same', '50% vs 5%', '10% vs 1%', '5% vs 50%', '20% vs 20%', 'B', 'Simple excision has 50% recurrence rate, while Sistrunk procedure has only 5% recurrence.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 6, 'Most common branchial cleft anomaly is:', 'First branchial cleft', 'Second branchial cleft', 'Third branchial cleft', 'Fourth branchial cleft', 'Fifth branchial cleft', 'B', 'Second branchial cleft anomalies account for 95% of all branchial cleft anomalies.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 7, 'Second branchial cleft cyst is typically located:', 'Midline', 'Anterior to sternocleidomastoid muscle', 'Posterior triangle', 'Submental region', 'Supraclavicular', 'B', 'Second branchial cleft cyst is located anterior to the SCM muscle, typically in the upper third of the neck.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 8, 'The tract of a second branchial cleft anomaly passes between:', 'Subclavian arteries', 'Internal and external carotid arteries', 'Jugular veins', 'Thyroid lobes', 'Vertebral arteries', 'B', 'The second branchial cleft tract passes between the internal and external carotid arteries to reach the tonsillar fossa.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 9, 'Cystic hygroma is most commonly located in the:', 'Anterior triangle', 'Posterior triangle', 'Midline', 'Submandibular area', 'Supraclavicular fossa', 'B', 'Cystic hygroma (lymphatic malformation) is most commonly located in the posterior triangle of the neck.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 10, 'A cystic hygroma characteristically:', 'Is hard and fixed', 'Transilluminates brilliantly', 'Moves with tongue protrusion', 'Is pulsatile', 'Has cough impulse', 'B', 'Cystic hygroma transilluminates brilliantly due to its lymph-filled cystic nature.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 11, 'Before excision of thyroglossal duct cyst, it is important to:', 'Perform CT scan', 'Confirm presence of normal thyroid tissue', 'Remove all lymph nodes', 'Perform thyroidectomy', 'Wait until puberty', 'B', 'Must confirm normal thyroid tissue is present, as the cyst may contain the only thyroid tissue in rare cases.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 12, 'Dermoid cyst differs from thyroglossal cyst in that it:', 'Is located laterally', 'Does NOT move with tongue protrusion', 'Transilluminates', 'Is always infected', 'Is malignant', 'B', 'Dermoid cyst does NOT move with tongue protrusion, while thyroglossal duct cyst does.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 13, 'Red flag features for malignancy in pediatric neck mass include all EXCEPT:', 'Supraclavicular location', 'Mobile and soft', 'Fixed to surrounding structures', 'Size greater than 3cm', 'B symptoms', 'B', 'Mobile and soft lymph nodes are reassuring. Fixed, hard, supraclavicular, large nodes with B symptoms suggest malignancy.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 14, 'Most common malignancy presenting as neck mass in children is:', 'Thyroid carcinoma', 'Lymphoma', 'Rhabdomyosarcoma', 'Neuroblastoma', 'Squamous cell carcinoma', 'B', 'Lymphoma (Hodgkin and Non-Hodgkin) is the most common malignancy presenting as neck mass in children.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 15, 'Thyroid nodule in a child moves with:', 'Tongue protrusion only', 'Swallowing only', 'Both tongue protrusion and swallowing', 'Neither', 'Coughing', 'B', 'Thyroid nodules move with swallowing only, not with tongue protrusion.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 16, 'Treatment of cystic hygroma includes:', 'Antibiotics only', 'Observation only', 'Surgery or sclerotherapy', 'Radiation', 'Chemotherapy', 'C', 'Treatment options for cystic hygroma include surgical excision or sclerotherapy (OK-432, bleomycin).'),
('d0000055-0000-0000-0000-000000000055'::uuid, 17, 'First branchial cleft anomaly may be associated with:', 'Tonsillar abnormality', 'Facial nerve involvement', 'Thyroid abnormality', 'Carotid artery aneurysm', 'Laryngeal abnormality', 'B', 'First branchial cleft anomalies, especially Type II, involve the parotid gland and may affect the facial nerve.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 18, 'Recurrent suppurative thyroiditis in a child should raise suspicion of:', 'Thyroglossal duct cyst', 'Third or fourth branchial cleft anomaly', 'Thyroid carcinoma', 'Graves disease', 'Hashimoto thyroiditis', 'B', 'Third and fourth branchial cleft anomalies can present as recurrent suppurative thyroiditis or neck abscess.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 19, 'First-line imaging investigation for pediatric neck mass is:', 'CT scan', 'MRI', 'Ultrasound', 'Plain X-ray', 'Nuclear scan', 'C', 'Ultrasound is the first-line imaging investigation - it is non-invasive, readily available, and differentiates solid from cystic.'),
('d0000055-0000-0000-0000-000000000055'::uuid, 20, 'The foramen cecum is located at the:', 'Base of tongue', 'Thyroid isthmus', 'Hyoid bone', 'Cricoid cartilage', 'Larynx', 'A', 'The foramen cecum is at the junction of anterior 2/3 and posterior 1/3 of the tongue - the embryological origin of the thyroid gland.');
