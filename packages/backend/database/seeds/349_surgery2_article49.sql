...
('d2000049-0000-0000-0000-000000000049'::uuid, 'content', 3, 'Clinical Assessment', 'HISTORY:
...
('d2000049-0000-0000-0000-000000000049'::uuid, 'content', 4, 'Investigation and Management', 'INITIAL INVESTIGATIONS:
...
('d2000049-0000-0000-0000-000000000049'::uuid, 1, 'Most common cause of visible haematuria in adults over 40 is:', 'Urinary tract infection', 'Bladder cancer', 'Kidney stones', 'BPH', 'Glomerulonephritis', 'B', 'Bladder cancer is the most common cause of visible haematuria in adults over 40 years old.'),
('d2000049-0000-0000-0000-000000000049'::uuid, 2, 'Painless haematuria is most concerning for:', 'UTI', 'Kidney stones', 'Malignancy', 'Glomerulonephritis', 'Trauma', 'C', 'Painless haematuria is a red flag for urological malignancy, particularly bladder cancer.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 4, 'Gold standard imaging for upper tract evaluation in haematuria is:', 'Ultrasound', 'Plain X-ray KUB', 'CT urogram', 'MRI', 'IVU', 'C', 'CT urogram (CTU) is the gold standard for evaluating the upper urinary tract in haematuria.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 7, 'Initial haematuria (blood at start of stream) suggests:', 'Bladder source', 'Kidney source', 'Urethral source', 'Ureteric source', 'Glomerular source', 'C', 'Initial haematuria suggests a urethral source of bleeding.'),
('d2000049-0000-0000-0000-000000000049'::uuid, 8, 'Terminal haematuria suggests:', 'Urethral source', 'Bladder neck or prostatic source', 'Renal source', 'Ureteric source', 'Glomerular source', 'B', 'Terminal haematuria (at end of stream) suggests bleeding from bladder neck or prostate.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 10, 'Most common glomerulonephritis causing haematuria is:', 'Post-streptococcal GN', 'IgA nephropathy', 'Membranous nephropathy', 'Minimal change disease', 'FSGS', 'B', 'IgA nephropathy (Berger disease) is the most common glomerulonephritis worldwide causing haematuria.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 12, 'Urine cytology is most useful for detecting:', 'Low-grade bladder tumors', 'High-grade urothelial carcinoma and CIS', 'Kidney stones', 'UTI', 'BPH', 'B', 'Urine cytology has high sensitivity for high-grade urothelial carcinoma and CIS, but poor sensitivity for low-grade tumors.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 14, 'RBC casts in urine indicate:', 'Bladder source', 'Urethral source', 'Glomerular source', 'Prostatic source', 'Contamination', 'C', 'RBC casts form in renal tubules and indicate glomerular or intrarenal bleeding.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 16, 'Schistosomiasis-related bladder cancer is usually:', 'Transitional cell carcinoma', 'Squamous cell carcinoma', 'Adenocarcinoma', 'Small cell carcinoma', 'Sarcoma', 'B', 'Schistosoma haematobium causes chronic bladder irritation leading to squamous cell carcinoma.'),
('d2000049-0000-0000-0000-000000000049'::uuid, 17, 'First-line imaging for low-risk non-visible haematuria is:', 'CT urogram', 'MRI', 'Ultrasound', 'Plain KUB', 'IVU', 'C', 'Ultrasound is appropriate first-line imaging for low-risk patients with non-visible haematuria.'),
('d2000049-0000-0000-0000-000000000049'::uuid, 18, 'Dysmorphic RBCs on urine microscopy suggest:', 'Bladder source', 'Urethral source', 'Glomerular source', 'Stone disease', 'Infection', 'C', 'Dysmorphic (irregular, fragmented) RBCs indicate passage through glomerular basement membrane.'),
...
('d2000049-0000-0000-0000-000000000049'::uuid, 20, 'Total haematuria (throughout stream) suggests source from:', 'Urethra', 'Prostate', 'Bladder or above (upper tract)', 'Bladder neck only', 'External genitalia', 'C', 'Total haematuria (blood throughout stream) suggests the source is from the bladder or upper urinary tract.');
