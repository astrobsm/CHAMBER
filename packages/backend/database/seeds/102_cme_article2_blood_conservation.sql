...
('a1100002-0000-0000-0000-000000000002', 'introduction', 'Introduction', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'learning_objectives', 'Learning Objectives', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'content', 'Preoperative Blood Conservation', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'content', 'Intraoperative Blood Conservation Techniques', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'content', 'Pharmacological Agents for Blood Conservation', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'content', 'Postoperative Blood Conservation and Transfusion Thresholds', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'key_points', 'Key Points', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'clinical_pearls', 'Clinical Pearls', 
...
INSERT INTO article_sections (article_id, section_type, title, content, section_order) VALUES
('a1100002-0000-0000-0000-000000000002', 'references', 'References', 'See reference list below.', 9);

-- Insert References
INSERT INTO article_references (article_id, reference_number, citation, doi, pubmed_id, url) VALUES
('a1100002-0000-0000-0000-000000000002', 1, 'Shander A, et al. Patient Blood Management: Science and Practice. Anesth Analg. 2012;115(4):807-815.', '10.1213/ANE.0b013e31824f4541', '22492184', NULL),
('a1100002-0000-0000-0000-000000000002', 2, 'CRASH-2 Trial Collaborators. Effects of tranexamic acid on death, vascular occlusive events, and blood transfusion in trauma patients with significant haemorrhage. Lancet. 2010;376(9734):23-32.', '10.1016/S0140-6736(10)60835-5', '20554319', NULL),
('a1100002-0000-0000-0000-000000000002', 3, 'Hébert PC, et al. A multicenter, randomized, controlled clinical trial of transfusion requirements in critical care (TRICC). N Engl J Med. 1999;340(6):409-417.', '10.1056/NEJM199902113400601', '9971864', NULL),
('a1100002-0000-0000-0000-000000000002', 4, 'Carson JL, et al. Liberal or restrictive transfusion in high-risk patients after hip surgery (FOCUS). N Engl J Med. 2011;365(26):2453-2462.', '10.1056/NEJMoa1012452', '22168590', NULL),
('a1100002-0000-0000-0000-000000000002', 5, 'Mazer CD, et al. Restrictive or liberal red-cell transfusion for cardiac surgery (TRICS III). N Engl J Med. 2017;377(22):2133-2144.', '10.1056/NEJMoa1711818', '29130845', NULL),
('a1100002-0000-0000-0000-000000000002', 6, 'Klein AA, et al. Association of Anaesthetists guidelines: cell salvage for peri-operative blood conservation. Anaesthesia. 2018;73(9):1141-1150.', '10.1111/anae.14331', '29893997', NULL),
('a1100002-0000-0000-0000-000000000002', 7, 'Muñoz M, et al. International consensus statement on the peri-operative management of anaemia and iron deficiency. Anaesthesia. 2017;72(2):233-247.', '10.1111/anae.13773', '27996086', NULL),
('a1100002-0000-0000-0000-000000000002', 8, 'Waters JH. Indications and contraindications of cell salvage. Transfusion. 2004;44(12 Suppl):40S-44S.', '10.1111/j.0041-1132.2004.04176.x', '15585005', NULL),
('a1100002-0000-0000-0000-000000000002', 9, 'Patidar GK, et al. Acute normovolemic hemodilution: A practical review. J Anaesthesiol Clin Pharmacol. 2015;31(2):249-254.', '10.4103/0970-9185.155163', '25948912', NULL),
('a1100002-0000-0000-0000-000000000002', 10, 'WOMAN Trial Collaborators. Effect of early tranexamic acid administration on mortality, hysterectomy, and other morbidities in women with post-partum haemorrhage (WOMAN). Lancet. 2017;389(10084):2105-2116.', '10.1016/S0140-6736(17)30638-4', '28456509', NULL);
...
('a1100002-0000-0000-0000-000000000002', 1,
...
'C',
'This patient has iron deficiency anemia (low ferritin and transferrin saturation) with 6 weeks until surgery. Oral iron supplementation is appropriate first-line therapy with sufficient time for response. IV iron would be considered if oral fails or is not tolerated. Preoperative transfusion should be avoided when there is time to treat the underlying cause. ESAs are reserved for specific indications and require adequate iron stores.', '{7}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 2,
...
'A',
'Blood collected during ANH should be stored at room temperature (not refrigerated) and must be reinfused within 8 hours. Room temperature storage preserves platelet function and coagulation factors. The blood is reinfused in reverse order (last out, first in) because the first units collected have the highest hematocrit.', '{9}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 4,
...
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 5,
...
'B',
'Current evidence supports the use of intraoperative cell salvage in cancer surgery with the addition of a leukocyte depletion filter before reinfusion. Studies have not shown increased cancer recurrence with cell salvage. The leukocyte filter removes tumor cells along with white blood cells. This represents a change from older guidelines that considered malignancy an absolute contraindication.', '{6,8}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 8,
...
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 10,
...
'B',
'For surgical blood conservation, tranexamic acid is typically dosed at 10-20 mg/kg IV given before incision, with possible repeat dosing. For trauma, the CRASH-2 protocol uses 1 g IV over 10 minutes followed by 1 g over 8 hours. The dose of 0.3 mcg/kg is the dose for DDAVP, not TXA.', '{2}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 11,
...
'90-100%',
'D',
'The final washed red cell product from cell salvage typically has a hematocrit of 50-80%. The washing process removes plasma, platelets, clotting factors, free hemoglobin, and debris. The concentrated red cells are suspended in saline. Quality indicators include hematocrit >50%, free hemoglobin <1%, and absence of fat globules.', '{6,8}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 12,
...
'5:1 ratio',
'C',
'When replacing blood with crystalloid during ANH, a 3:1 ratio is used (3 mL crystalloid for every 1 mL blood removed). If colloid is used instead, a 1:1 ratio is appropriate. The goal is to maintain normovolemia while achieving the target hematocrit of 25-30%.', '{9}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 15,
...
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 17,
...
'C',
'The WOMAN trial showed that tranexamic acid significantly reduced death due to bleeding in women with postpartum hemorrhage, particularly when given within 3 hours of delivery. There was no increase in thromboembolic events. This has led to TXA being included in guidelines for PPH management worldwide.', '{10}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 18,
...
'B',
'DDAVP releases von Willebrand factor and Factor VIII from endothelial storage sites (Weibel-Palade bodies). With repeated dosing, these stores become depleted, leading to diminished response (tachyphylaxis). For this reason, doses should be spaced at least 24-48 hours apart, and the drug becomes less effective with each successive dose.', '{1}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 19,
...
'2000 mL',
'C',
'Cell salvage is generally recommended when anticipated blood loss exceeds 1000 mL or when there is anticipated need for transfusion. The cost-effectiveness threshold varies by institution, but 1000 mL is a commonly used guideline. The setup and processing costs must be weighed against the potential benefit.', '{6,8}');

INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation, reference_numbers) VALUES
('a1100002-0000-0000-0000-000000000002', 20,
...
'D',
'Cell salvage can be used in obstetric surgery with the addition of a leukocyte depletion filter. The concern about amniotic fluid contamination and risk of amniotic fluid embolism has been addressed in studies showing safety with leukocyte filters. This is particularly valuable for patients at high risk of major hemorrhage or those who decline allogeneic transfusion.', '{6}');
