...
('d2000048-0000-0000-0000-000000000048'::uuid, 'content', 3, 'Clinical Features and Diagnosis', 'SIGNS OF URETHRAL INJURY:
...
('d2000048-0000-0000-0000-000000000048'::uuid, 'content', 4, 'Management', 'IMMEDIATE MANAGEMENT:
...
('d2000048-0000-0000-0000-000000000048'::uuid, 'clinical_pearls', 5, 'Clinical Pearls', 'Blood at meatus - do not catheterize until RUG performed. Straddle injury affects bulbar urethra. Pelvic fracture injury affects membranous urethra. High-riding prostate indicates posterior injury. Delayed repair preferred for complete posterior injuries. Stricture is the most common complication.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 'key_points', 6, 'Key Points Summary', 'Posterior injuries: prostatic and membranous urethra, pelvic fracture. Anterior injuries: bulbar, penile, straddle injury. Classic triad: blood at meatus, inability to void, palpable bladder. RUG is diagnostic gold standard. Do not catheterize before imaging. Suprapubic catheter for complete injuries. Delayed urethroplasty preferred for posterior injuries.');

-- Insert MCQs
INSERT INTO article_self_assessments (article_id, question_number, question_text, option_a, option_b, option_c, option_d, option_e, correct_option, explanation) VALUES
('d2000048-0000-0000-0000-000000000048'::uuid, 1, 'The posterior urethra consists of:', 'Penile and bulbar portions', 'Prostatic and membranous portions', 'Fossa navicularis and meatus', 'Bulbar and membranous portions', 'All urethral portions', 'B', 'Posterior urethra includes prostatic and membranous urethra, above the urogenital diaphragm.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 2, 'Straddle injury typically affects:', 'Prostatic urethra', 'Membranous urethra', 'Bulbar urethra', 'Penile urethra', 'Fossa navicularis', 'C', 'Straddle injury compresses the bulbar urethra against the inferior pubic ramus.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 3, 'Pelvic fracture urethral injury typically affects:', 'Bulbar urethra', 'Penile urethra', 'Membranous urethra', 'Fossa navicularis', 'All parts equally', 'C', 'Pelvic fracture injuries affect the membranous urethra at the prostatomembranous junction.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 4, 'Cardinal sign of urethral injury is:', 'Hematuria', 'Blood at urethral meatus', 'Fever', 'Dysuria', 'Suprapubic pain', 'B', 'Blood at the urethral meatus is the cardinal sign suggesting urethral injury.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 5, 'When urethral injury is suspected, the first action should be:', 'Attempt catheterization', 'Perform cystoscopy', 'Perform retrograde urethrography', 'Administer antibiotics', 'Place suprapubic catheter immediately', 'C', 'Retrograde urethrography (RUG) should be performed before any attempt at catheterization.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 6, 'High-riding prostate on DRE suggests:', 'Anterior urethral injury', 'Posterior urethral disruption', 'BPH', 'Prostate cancer', 'Bladder injury only', 'B', 'High-riding or impalpable prostate indicates posterior urethral disruption with prostatic displacement.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 7, 'Butterfly perineal hematoma is seen in:', 'Posterior urethral injury', 'Anterior urethral injury with Buck fascia disruption', 'Bladder rupture', 'Penile fracture', 'Testicular torsion', 'B', 'Butterfly hematoma occurs when urine and blood extravasate deep to Colles fascia after anterior injury.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 8, 'Gold standard investigation for urethral injury is:', 'CT cystogram', 'Ultrasound', 'Retrograde urethrography', 'MRI', 'Cystoscopy', 'C', 'Retrograde urethrography (RUG) is the gold standard to diagnose and classify urethral injuries.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 9, 'Management of complete posterior urethral injury is:', 'Immediate primary repair', 'Suprapubic catheter and delayed repair', 'Urethral catheter', 'Conservative only', 'Cystoscopy', 'B', 'Complete posterior injuries are best managed with suprapubic drainage and delayed urethroplasty (3-6 months).'),
('d2000048-0000-0000-0000-000000000048'::uuid, 10, 'Most common complication of urethral injury is:', 'Impotence', 'Stricture formation', 'Incontinence', 'Fistula', 'Recurrent UTI', 'B', 'Urethral stricture is the most common complication, occurring in 50% or more of injuries.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 11, 'Buck fascia limits spread of extravasated urine to:', 'Penis only', 'Scrotum only', 'Thighs', 'Abdomen', 'Penis, with potential spread beyond if disrupted', 'E', 'Intact Buck fascia confines extravasation to the penis. If disrupted, spread follows Colles fascia.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 12, 'Urine extravasation in anterior urethral injury with disrupted Buck fascia follows:', 'Deep perineal pouch', 'Colles fascia to scrotum, perineum, anterior abdominal wall', 'Into thigh', 'Retroperitoneum', 'Peritoneal cavity', 'B', 'When Buck fascia is disrupted, extravasation follows Colles fascia but does NOT extend to thighs (attached to inguinal ligament).'),
('d2000048-0000-0000-0000-000000000048'::uuid, 13, 'Percentage of pelvic fractures associated with urethral injury is approximately:', '1-2%', '5-10%', '25-30%', '50%', '75%', 'B', 'Approximately 5-10% of pelvic fractures are associated with urethral injury.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 14, 'Primary realignment for posterior urethral injury may:', 'Always cause stricture', 'Reduce stricture length but increase ED risk', 'Be the only option', 'Always be performed', 'Eliminate need for follow-up', 'B', 'Primary realignment is controversial - may reduce stricture length but has not been shown to reduce stricture rate or improve ED.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 15, 'For anterior urethral stricture greater than 2cm, treatment is:', 'End-to-end anastomosis', 'Buccal mucosal graft urethroplasty', 'Dilation only', 'Internal urethrotomy only', 'Suprapubic catheter only', 'B', 'Strictures greater than 2cm usually require substitution urethroplasty with buccal mucosa or skin flap.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 16, 'The membranous urethra is:', 'Longest part of urethra', 'Shortest and least distensible part', 'Most mobile part', 'Within the prostate', 'Part of anterior urethra', 'B', 'The membranous urethra (through urogenital diaphragm) is the shortest and least distensible segment.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 17, 'Attempting catheterization in complete urethral rupture may:', 'Help diagnosis', 'Convert partial to complete tear', 'Be therapeutic', 'Be without risk', 'Aid in drainage', 'B', 'Catheterization attempt may worsen partial injuries and create false passages - avoid until RUG performed.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 18, 'Female urethral injury is rare because:', 'Different blood supply', 'Urethra is short and mobile', 'Protected by bony pelvis', 'Larger diameter', 'Different fascial attachments', 'B', 'The female urethra is short (4cm) and mobile, making it less vulnerable to pelvic fracture injuries.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 19, 'Delayed urethroplasty for posterior urethral injury is performed after:', '1-2 weeks', '3-6 months', '1 year', '2 years', 'Immediately', 'B', 'Delayed repair at 3-6 months allows inflammation and hematoma to resolve, making surgery easier and outcomes better.'),
('d2000048-0000-0000-0000-000000000048'::uuid, 20, 'Erectile dysfunction following pelvic fracture urethral injury is due to:', 'Urethral stricture', 'Injury to cavernosal nerves and vessels', 'Catheter placement', 'Antibiotics', 'Psychological factors only', 'B', 'ED results from injury to the cavernosal nerves and internal pudendal vessels during the pelvic trauma.');
