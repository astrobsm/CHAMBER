...
('d0000047-0000-0000-0000-000000000047'::uuid, 'content', 2, 'Classification of LUTS', 'LUTS are categorized into three groups based on the phase of the micturition cycle affected:
...
('d0000047-0000-0000-0000-000000000047'::uuid, 'content', 3, 'IPSS - International Prostate Symptom Score', 'IPSS QUESTIONNAIRE: Seven symptom questions scored 0-5 (total 0-35) plus one quality of life question.
...
('d0000047-0000-0000-0000-000000000047'::uuid, 'content', 4, 'Assessment and Investigation', 'HISTORY: Detailed symptom assessment using IPSS, duration, impact on QoL, fluid intake patterns, medication review (diuretics, antihistamines, decongestants), comorbidities, sexual function.
...
('d0000047-0000-0000-0000-000000000047'::uuid, 2, 'Storage symptoms include all EXCEPT:', 'Frequency', 'Urgency', 'Nocturia', 'Hesitancy', 'Urge incontinence', 'D', 'Hesitancy is a voiding symptom. Storage symptoms include frequency, urgency, nocturia, incontinence.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 3, 'Voiding symptoms include all EXCEPT:', 'Weak stream', 'Straining', 'Intermittency', 'Urgency', 'Terminal dribbling', 'D', 'Urgency is a storage symptom. Voiding symptoms include weak stream, straining, intermittency, hesitancy.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 4, 'IPSS has how many symptom questions?', '5', '6', '7', '8', '10', 'C', 'IPSS has 7 symptom questions (each scored 0-5) plus one quality of life question.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 5, 'Maximum IPSS symptom score is:', '21', '28', '35', '42', '50', 'C', 'Maximum IPSS symptom score is 35 (7 questions x 5 points each).'),
('d0000047-0000-0000-0000-000000000047'::uuid, 6, 'Moderate LUTS on IPSS is defined as:', '0-7', '8-19', '20-35', '15-25', '10-20', 'B', 'IPSS interpretation: mild (0-7), moderate (8-19), severe (20-35).'),
('d0000047-0000-0000-0000-000000000047'::uuid, 7, 'The quality of life question in IPSS is scored:', '0-5', '0-6', '0-7', '0-10', '1-5', 'B', 'QoL question: How would you feel living with current symptoms? Scored 0 (delighted) to 6 (terrible).'),
('d0000047-0000-0000-0000-000000000047'::uuid, 8, 'Normal Qmax on uroflowmetry is:', 'Less than 5 ml/s', 'Less than 10 ml/s', 'Greater than 15 ml/s', 'Greater than 5 ml/s only', 'Any value', 'C', 'Normal Qmax is greater than 15 ml/s. Less than 15 ml/s suggests bladder outlet obstruction.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 9, 'Post-void residual volume considered significant is:', 'Greater than 50 ml', 'Greater than 100-200 ml', 'Greater than 500 ml only', 'Any amount', 'Greater than 20 ml', 'B', 'PVR greater than 100-200 ml is generally considered significant and may indicate retention.'),
...
('d0000047-0000-0000-0000-000000000047'::uuid, 11, 'Frequency-volume chart helps assess:', 'Prostate size', 'Fluid intake and voiding patterns', 'PSA level', 'Kidney function', 'Bladder compliance', 'B', 'Frequency-volume chart (bladder diary) records void times, volumes, and fluid intake over 3 days.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 12, 'Overactive bladder (OAB) primarily causes:', 'Voiding symptoms', 'Storage symptoms', 'Post-micturition symptoms', 'Obstructive symptoms only', 'No symptoms', 'B', 'OAB is characterized by storage symptoms: urgency (with or without incontinence), frequency, and nocturia.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 13, 'Which IPSS question specifically asks about nocturia?', 'Question 1', 'Question 4', 'Question 5', 'Question 7', 'Quality of life question', 'D', 'Question 7 asks about nocturia: how many times do you typically get up at night to urinate?'),
('d0000047-0000-0000-0000-000000000047'::uuid, 14, 'Plateau pattern on uroflowmetry suggests:', 'Normal voiding', 'Urethral stricture or obstruction', 'Overactive bladder', 'Large prostate only', 'Detrusor overactivity', 'B', 'Plateau (flat) pattern on uroflowmetry is characteristic of urethral stricture or fixed obstruction.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 15, 'Bell-shaped curve on uroflowmetry indicates:', 'Obstruction', 'Normal voiding pattern', 'Stricture', 'Detrusor failure', 'Bladder stones', 'B', 'A bell-shaped curve is the normal uroflowmetry pattern indicating unobstructed voiding.'),
...
('d0000047-0000-0000-0000-000000000047'::uuid, 17, 'Medications that may worsen LUTS include:', 'Alpha-blockers', 'Antihistamines and decongestants', 'Tamsulosin', 'Finasteride', 'Tadalafil', 'B', 'Antihistamines (anticholinergic) and decongestants (alpha-agonists) can worsen LUTS.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 18, 'Post-micturition symptoms include:', 'Frequency', 'Urgency', 'Post-void dribbling and incomplete emptying sensation', 'Hesitancy', 'Nocturia', 'C', 'Post-micturition symptoms are post-void dribbling and sensation of incomplete emptying.'),
('d0000047-0000-0000-0000-000000000047'::uuid, 19, 'Polyuria is defined as 24-hour urine output greater than:', '1 liter', '2 liters', '3 liters', '4 liters', '5 liters', 'C', 'Polyuria is defined as 24-hour urine output greater than 3 liters (3000 ml).'),
('d0000047-0000-0000-0000-000000000047'::uuid, 20, 'IPSS is validated for:', 'Women only', 'Men only', 'Both men and women', 'Children only', 'Post-surgical patients only', 'C', 'Although originally for prostate symptoms, IPSS is validated and used for LUTS assessment in both sexes.');
