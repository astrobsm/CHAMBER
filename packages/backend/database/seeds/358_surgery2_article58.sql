...
('d0000058-0000-0000-0000-000000000058'::uuid, 'content', 3, 'Targeted Therapies', 'MONOCLONAL ANTIBODIES (suffix: -mab):
...
- Synthetic lethality'),
('d0000058-0000-0000-0000-000000000058'::uuid, 'content', 4, 'Surgical Implications and Applications', 'IMPLICATIONS FOR SURGICAL ONCOLOGY:
...
('d0000058-0000-0000-0000-000000000058'::uuid, 2, 'Trastuzumab (Herceptin) targets:', 'EGFR', 'HER2', 'VEGF', 'c-KIT', 'CD20', 'B', 'Trastuzumab is a monoclonal antibody targeting HER2 receptor in breast and gastric cancer.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 3, 'Which targeted therapy revolutionized GIST treatment?', 'Trastuzumab', 'Bevacizumab', 'Imatinib', 'Rituximab', 'Erlotinib', 'C', 'Imatinib targets c-KIT and revolutionized GIST treatment, converting a chemoresistant tumor to a treatable disease.'),
...
('d0000058-0000-0000-0000-000000000058'::uuid, 5, 'Bevacizumab should be held before surgery for:', '1 week', '2 weeks', '4-6 weeks', '3 months', 'No need to hold', 'C', 'Bevacizumab (anti-VEGF) should be held 4-6 weeks before and after surgery due to wound healing complications.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 6, 'BRAF V600E mutation is commonly found in:', 'Breast cancer', 'Colorectal cancer only', 'Melanoma', 'Prostate cancer', 'Lung adenocarcinoma only', 'C', 'BRAF V600E mutation is common in melanoma (50%) and is targeted by vemurafenib and dabrafenib.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 7, 'PARP inhibitors are particularly effective in:', 'All breast cancers', 'BRCA-mutated cancers', 'HER2-positive cancers', 'KRAS-mutated cancers', 'MSI-high cancers', 'B', 'PARP inhibitors exploit synthetic lethality in BRCA-mutated cancers deficient in homologous recombination.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 8, 'Suffix -mab in drug names indicates:', 'Small molecule inhibitor', 'Monoclonal antibody', 'Chemotherapy agent', 'Hormone therapy', 'Immunomodulator', 'B', 'The suffix -mab indicates monoclonal antibody (trastuzumab, bevacizumab, rituximab).'),
('d0000058-0000-0000-0000-000000000058'::uuid, 9, 'c-KIT mutation is found in what percentage of GIST?', '10-20%', '40-50%', '80-85%', '95-100%', 'Not found in GIST', 'C', 'c-KIT mutations are found in 80-85% of GIST, making it the defining molecular feature.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 10, 'EGFR TKIs (erlotinib, gefitinib) are indicated for:', 'All lung cancers', 'EGFR-mutant lung adenocarcinoma', 'Small cell lung cancer', 'Squamous cell lung cancer', 'Colorectal cancer', 'B', 'EGFR TKIs are indicated for EGFR-mutant (exon 19 deletion, L858R) lung adenocarcinoma.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 11, 'Rituximab targets:', 'HER2', 'VEGF', 'CD20', 'EGFR', 'c-KIT', 'C', 'Rituximab is a monoclonal antibody targeting CD20 on B-cells, used in lymphoma and leukemia.'),
...
('d0000058-0000-0000-0000-000000000058'::uuid, 14, 'Cardiotoxicity is a major side effect of:', 'Imatinib', 'Trastuzumab', 'Bevacizumab', 'Cetuximab', 'Erlotinib', 'B', 'Trastuzumab has significant cardiotoxicity risk, requiring cardiac monitoring during treatment.'),
...
('d0000058-0000-0000-0000-000000000058'::uuid, 16, 'Which pathway is targeted by mTOR inhibitors like everolimus?', 'RAS-RAF-MEK-ERK', 'PI3K-AKT-mTOR', 'JAK-STAT', 'Wnt-beta catenin', 'Notch pathway', 'B', 'Everolimus inhibits mTOR in the PI3K-AKT-mTOR pathway, used in RCC and breast cancer.'),
('d0000058-0000-0000-0000-000000000058'::uuid, 17, 'ALK-rearranged lung cancer is treated with:', 'EGFR TKIs', 'ALK inhibitors like crizotinib', 'BRAF inhibitors', 'PARP inhibitors', 'Standard chemotherapy only', 'B', 'ALK-rearranged lung cancer responds to ALK inhibitors (crizotinib, alectinib).'),
('d0000058-0000-0000-0000-000000000058'::uuid, 18, 'Neoadjuvant imatinib in GIST is used for:', 'All GIST tumors', 'Borderline resectable or unresectable tumors', 'Post-operative only', 'Recurrent disease only', 'Wild-type GIST', 'B', 'Neoadjuvant imatinib is used to downstage borderline resectable or unresectable GIST tumors.'),
...
('d0000058-0000-0000-0000-000000000058'::uuid, 20, 'The suffix -ib in drug names indicates:', 'Monoclonal antibody', 'Small molecule inhibitor', 'Chemotherapy', 'Hormone analog', 'Vaccine', 'B', 'The suffix -ib indicates small molecule inhibitor (imatinib, erlotinib, vemurafenib).');
